...
function getUserData(anyUser: iUser): iUser {
...
export const userMaggie: iUser = getUserData({
...
export const userPeter: iUser = getUserData({
...
function getFavoritesAmount(name: string) {
